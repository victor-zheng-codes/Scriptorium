...
const Code = () => {
  ...
  return (
    <Layout>
        ...
        <div className="m-4 flex items-center space-x-2 text-gray-600 dark:text-gray-300">
          <Label htmlFor="language-select" className="block text-lg font-medium">
            Choose Language:
          </Label>
          <select
            id="language-select"
            ...
            className="p-2 w-48 bg-gray-100 dark:bg-gray-950 border border-gray-300 rounded-md text-lg"
          >
