...
export default async function handler(req, res) {
    ...
    const { content, title, tags, templates } = req.query;
    ...
    const buildWhereConditions = () => {
        return [
            ...
            // If content exists, only include blogs whose content contains
            // the content string passed in the query (case insensitive)
