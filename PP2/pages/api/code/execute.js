...
export default async function handler(req, res) {
    ...
    switch (language.toLowerCase()) {
        ...
        case "go":
            ...
            const goExecutablePath = `tmp/main`;

            codeFilePath += goFilePath;

        case "csharp":
            // TODO: add c# file path (and executable path if necessary, i dont know how this language works lol)
            //const csharpFilePath = ``;
    ...
    // const command = `docker run --rm -v ${codePath}:/app -w /app ${image} <run-command>`;
